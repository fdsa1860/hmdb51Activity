...
% end
% 
% nCenter = size(trainCenter,1);
% dFeat = zeros(nCenter,length(allDataSet));
% % load dFeat6625;
...
%     class_hist = findDenseHist(trainCenter', X, true);
%     dFeat(:,i) = class_hist;
%     
%     save dFeat dFeat
...
% save dFeat4000_hmdb51_L108_20140514 dFeat allDataLabel allDataSplit
load ../expData/dFeat4000_hmdb51_L108_20140514.mat
...
X2_train = dFeat(:,allDataSplit==1);
y2_train = allDataLabel(allDataSplit==1)';
X2_test = dFeat(:,allDataSplit==2);
