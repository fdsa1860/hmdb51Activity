...
void InitSeqInfo(SeqInfo* seqInfo, char* video)
{
    ...
    seqInfo->width = (int) capture.get(CV_CAP_PROP_FRAME_WIDTH);
	seqInfo->height = (int) capture.get(CV_CAP_PROP_FRAME_HEIGHT);
	seqInfo->length = (int) capture.get(CV_CAP_PROP_FRAME_COUNT);
